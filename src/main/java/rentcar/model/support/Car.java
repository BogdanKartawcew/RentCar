 ...
 */
@Entity
@Table(name = "CAR", uniqueConstraints = {@UniqueConstraint(columnNames = "CARID"), @UniqueConstraint(columnNames = "VIN")})
public class Car implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(carId, carBrand, carModel, carFuel, carGearType, carHorsePower, carBodyType, carDoorsNum, carSeatsNum, carAirCond, carNavigation, vin, regNum, carYear, carMileage, carVersion);
    }
